          ...
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="bahasa" name="bahasa" placeholder="Inggris, Jepang, mandarin, dst.">
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
                <label for="jenis">Jenis</label>
                <input type="text" class="form-control" id="jenis" name="jenis" placeholder="Pelatihan, Test, Pelatihan dan Test.">
              </div>
            </div>
          </div>
          <div class="row">
